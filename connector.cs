...
function OnUpdate() {
    ...
    while (Flag == "NULL") {
        var webRequest = System.Net.WebRequest.Create("http://localhost:5000/getsignal") as System.Net.HttpWebRequest;
    ...
    var resetRequest = System.Net.WebRequest.Create("http://localhost:5000/resetsignal") as System.Net.HttpWebRequest;
